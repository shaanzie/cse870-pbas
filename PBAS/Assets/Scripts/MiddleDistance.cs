...
public class MiddleDistance : GreenCar
{
    ...
    void OnTriggerEnter(Collider objectName)
    {
        ...
        if(Time.frameCount % interval == 0)
        {
            ...
            distanceText.text = "Object detected in MD!";
            objectName.gameObject.GetComponentInChildren<Renderer>().material.color = HexToColor("FFE600");
            Debug.Log(interval);
        }
    }
